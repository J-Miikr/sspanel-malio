...
$I18N['plans-info'] = array(   // 会员计划的信息， 可以复制 array 增加会员计划，比如增加第四个会员计划，使用 'plan_4' => array(...) 这样的格式
	'en' => [
		'plan_1' => array(
			'name' => 'Basic',
			'price' => '1.9',
...
$I18N['index-user-reviews'] = array(
	...
	'zh-cn' => [
		array(
			'user' => '某一沙雕网友',
			'position' => '学生',
			'review' => '查阅资料真的好用，网速很快，观看NF等也很方便，好用到起飞'
		),
		array(
			'user' => '蔡某',
			'position' => '个人练习生',
...
$I18N['closed-on-registeration'] = array(
	'en' => '\$1 已停止新用户注册',
	'zh-cn' => '\$1 has closed on registration'
);
$I18N['nickname'] = array(
	'en' => 'Nickname',
	'zh-cn' => '昵称'
...
$I18N['no-available-data-alert'] = array(
	...
	'zh-cn' => '您的流量已用尽，无法继续使用本站服务。如需继续使用，请前往会员商店订阅。'
);
...
$I18N['quick-import'] = array(
	'en' => 'Quick Import',
	'zh-cn' => '便捷导入(更多订阅请前往<a href="https://t.me/spccat_bot" target="_blank">tg机器人</a>查询)'
);
...
$I18N['store-sub-title'] = array(
	'en' => 'We Dedicate to Providing the Finest Network Proxy Service',
	'zh-cn' => '折扣码使用方法：计算折扣后价格->充值到余额->购买时输入'
);
...
$I18N['reset-invitation-link-desc'] = array(
	...
	'zh-cn' => '确定要重置邀请链接吗？点击确定后会重置并自动刷新本页。'
);
$I18N['reward'] = array(
	'en' => 'Reward',
	'zh-cn' => '获得返利'
...
$I18N['traffic-history-notice'] = array(
	...
	'zh-cn' => '您可在此查询您账户3天内的流量记录，确保您的账户没有被盗用'
);
...
$I18N['no-access-to-shared-account-desc'] = array(
	'en' => 'Your current plan does not have access to this account.',
...
$I18N['server-password-desc'] = array(
	...
	'zh-cn' => '您需要了解的是，此密码只与节点密码有关不会更改您的账户登录密码，修改后请注意及时更新托管订阅。'
);
...
$I18N['reset-config-url-desc'] = array(
	'en' => 'Click to reset your subscribe link. This operation is not invertible.',
...
$I18N['relay-server-in-between'] = array(
...
$I18N['purchase_info'] = array(
	'en' => '',
	'zh-cn' => '您当前等级购买此订阅会被覆盖，详情查看<a href="/user/tutorial?os=faq" target="_blank">常见问题</a>'
);
$I18N['failed'] = array(
	'en' => 'Failed',
	'zh-cn' => '失败'
...
$I18N['reset-config-url-confirm-modal-desc'] = array(
	'en' => 'This operation is not invertible',
	'zh-cn' => '此操作不可逆，请谨慎操作'
);
...
$I18N['customize-inivitation-link-successfully'] = array(
	'en' => 'Customize invitation link successfully',
	'zh-cn' => '成功定制邀请链接后缀'
);
